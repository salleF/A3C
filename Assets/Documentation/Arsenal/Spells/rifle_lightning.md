...
ID: `rifle_lightning` | Relâmpago | Rifles | [Asset Unity](../../../Data/Arsenal/Cartridges/rifle_lightning.asset) | [Índice](../README.md)

## Papel tático

**Bloqueio + Observação.** Partículas ionizadas criam bloqueio visual curto, acompanhado de uma leitura inicial de assinaturas próximas. Sem ricochete ou dano adicional.
...
|---|---|---|---|---|---|
| Fumaça | Mundo | Impacto | 4 s | 2.5 m | Não se aplica |
| Revelação | Inimigos | Impacto | 1.2 s | 3 m | Não se aplica |

- **Fumaça:** Cortina opaca de ambos os lados.
- **Revelação:** Uma amostra de posição no impacto, sem rastreamento contínuo.
...
Esperar os 4 s de cortina ou reposicionar após o pulso. Jogadores atrás de cobertura não são detectados.

## Apresentação no universo de Crushle

Rede de filamentos dourados em névoa violeta tênue; borda sólida identifica o volume de visão bloqueada.
