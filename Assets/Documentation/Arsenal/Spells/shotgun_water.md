...
ID: `shotgun_water` | Água | Escopetas | [Asset Unity](../../../Data/Arsenal/Cartridges/shotgun_water.asset) | [Índice](../README.md)

## Papel tático

**Controle + Bloqueio.** Forma um tapete de geada temporária no impacto para impedir que o alvo escape facilmente do alcance da escopeta.
...
|---|---|---|---|---|---|
| Lentidão | Inimigos | Impacto | 3 s | 2.5 m | 40% |

- **Lentidão:** Lentidão de 40% enquanto na geada; termina ao sair. Não congela nem impede disparo.
...
Identificar o chão brilhante antes de entrar. A área não desliza o personagem nem altera a sensibilidade de mira.

## Apresentação no universo de Crushle

Cristais rasos azul-claro, borda serrilhada e som de gelo fino rachando.
