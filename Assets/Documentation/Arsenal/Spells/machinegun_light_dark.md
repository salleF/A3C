...
ID: `machinegun_light_dark` | Luz & Escuridão | Metralhadora | [Asset Unity](../../../Data/Arsenal/Cartridges/machinegun_light_dark.asset) | [Índice](../README.md)

## Papel tático

**Controle + Bloqueio.** Escuridão ocupa a passagem e Luz pressiona a precisão dos inimigos expostos na área. É um único elemento dual, sem cura nesta família.
...
|---|---|---|---|---|---|
| Fumaça | Mundo | Impacto | 4 s | 3.5 m | Não se aplica |
| Supressão | Inimigos | Impacto | 4 s | 3.5 m | 15% |

- **Fumaça:** Metade Escuridão: bloqueio visual simétrico.
- **Supressão:** Metade Luz: 15% de dispersão adicional na zona, sem dano nem drenagem de escudo.
...
Recuar do domínio ou usar rota alternativa. Supressão termina ao sair, e o atirador não ganha visão através da nuvem.

## Apresentação no universo de Crushle

Esfera grafite com linhas brancas de contenção, duas notas sonoras e runa dupla que perde partes conforme o tempo acaba.
