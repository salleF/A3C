# Bastião Sismográfico

ID: `rifle_earth` | Terra | Rifles | [Asset Unity](../../../Data/Arsenal/Cartridges/rifle_earth.asset) | [Índice](../README.md)

## Papel tático

**Bloqueio + Observação.** Barreira temporária interrompe um corredor; a onda de assentamento registra posições próximas com visão livre ao redor da base.
...
| Revelação | Inimigos | Impacto | 0.8 s | 4 m | Não se aplica |

- **Barreira:** Parede com 0,4 m de profundidade; manter rota alternativa e acesso ao objetivo. Vida: 180 HP. Largura: 3 m. Altura: 2 m.
- **Revelação:** Apenas ping inicial; o teste de cobertura usa o mundo antes da nova barreira.
...
Destruir a barreira ou usar rota lateral. O registro é pontual, por isso mover após a ativação remove a vantagem de informação.

## Apresentação no universo de Crushle

Placas de fortaleza com juntas de cobre e círculos de sismógrafo holográfico na base.
