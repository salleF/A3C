...
ID: `smg_light_dark` | Luz & Escuridão | SMGs | [Asset Unity](../../../Data/Arsenal/Cartridges/smg_light_dark.asset) | [Índice](../README.md)

## Papel tático

**Avanço + Controle.** Uma única ativação combina Luz, que acelera o usuário, e Escuridão, que reduz brevemente a visão dos inimigos expostos no impacto. Não cura, pois esta família é de avanço e controle.
...
|---|---|---|---|---|---|
| Velocidade | Próprio usuário | Usuário | 1.5 s | 0 m | 10% |
| Ofuscamento | Inimigos | Impacto | 0.4 s | 2 m | 40% |

- **Velocidade:** A metade de Luz acelera 10%; não empilha bônus.
- **Ofuscamento:** A metade de Escuridão ofusca até 40%, somente com linha de visão e alvo olhando o impacto.
...
Virar o rosto ou usar cobertura quebra a exposição ao ofuscamento. O som de duas notas avisa a ativação.

## Apresentação no universo de Crushle

Anéis branco e negro entrelaçados, runa bipartida e contraste de forma além da cor.
