...
ID: `sniper_water` | Água | Snipers | [Asset Unity](../../../Data/Arsenal/Cartridges/sniper_water.asset) | [Índice](../README.md)

## Papel tático

**Observação + Suporte.** Gotículas revelam a última posição inimiga no impacto; orvalho de suporte restaura um pouco de vida real aos aliados próximos do atirador.
...
|---|---|---|---|---|---|
| Revelação | Inimigos | Impacto | 1 s | 4 m | Não se aplica |
| Cura | Aliados | Usuário | 0 s | 3 m | 15 HP reais |

- **Revelação:** Ping de posição, sem varredura global.
- **Cura:** Cura única de 15 HP reais, limitada a 100 HP. Não toca escudo, não cura mortos e não exige acertar aliado com bala.
...
Mudar de posição após o ping. A cura exige aliados agrupados no momento do disparo e não reanima eliminados.

## Apresentação no universo de Crushle

Runas de lente azul no impacto e pequenas gotas subindo ao redor dos aliados, sem aumentar brilho do personagem inteiro.
