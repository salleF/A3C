# Caldeira de Contenção

ID: `machinegun_fire` | Fogo | Metralhadora | [Asset Unity](../../../Data/Arsenal/Cartridges/machinegun_fire.asset) | [Índice](../README.md)

## Papel tático

**Controle + Bloqueio.** Cria uma zona de vapor e cinzas que desencoraja avanço, reduzindo a velocidade inimiga e bloqueando visão durante a supressão.
...
|---|---|---|---|---|---|
| Fumaça | Mundo | Impacto | 4 s | 3 m | Não se aplica |
| Lentidão | Inimigos | Impacto | 4 s | 3 m | 20% |

- **Fumaça:** Fumaça opaca de ambos os lados.
- **Lentidão:** Lentidão de 20% enquanto dentro, removida ao sair.
...
Contornar ou aguardar os 4 s da zona; o atirador também perde visão através da fumaça. Não há dano de queimadura.

## Apresentação no universo de Crushle

Vapor lateral, cinzas baixas e selo de caldeira no solo, sem partículas que ocultem toda a arena.
