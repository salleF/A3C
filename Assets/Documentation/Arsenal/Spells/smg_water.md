...
ID: `smg_water` | Água | SMGs | [Asset Unity](../../../Data/Arsenal/Cartridges/smg_water.asset) | [Índice](../README.md)

## Papel tático

**Avanço + Controle.** Água rúnica marca o chão do impacto. Inimigos que atravessam a poça perdem velocidade, abrindo espaço para a entrada do esquadrão.
...
|---|---|---|---|---|---|
| Lentidão | Inimigos | Impacto | 2 s | 2 m | 35% |

- **Lentidão:** Reduz velocidade em 35% enquanto dentro. Sair remove o slow; reentrar não renova a duração da área.
...
Evitar a poça de 2 m ou esperar sua evaporação. Não prende salto, rotação de mira ou disparo.

## Apresentação no universo de Crushle

Ondas concêntricas ciano com pequenas gotas suspensas e borda nítida sobre a pedra.
