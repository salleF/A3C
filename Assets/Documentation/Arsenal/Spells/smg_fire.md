...
ID: `smg_fire` | Fogo | SMGs | [Asset Unity](../../../Data/Arsenal/Cartridges/smg_fire.asset) | [Índice](../README.md)

## Papel tático

**Avanço + Controle.** Pulso térmico acelera o usuário por 2 s e deixa no ponto de impacto uma nuvem curta, permitindo cruzar uma porta de Crushle. Não causa queimadura.
...
|---|---|---|---|---|---|
| Velocidade | Próprio usuário | Usuário | 2 s | 0 m | 10% |
| Fumaça | Mundo | Impacto | 2 s | 1.5 m | Não se aplica |

- **Velocidade:** Multiplicador de velocidade 1 + amount. Não acumula com outro bônus elemental.
- **Fumaça:** Nuvem opaca para ambos os times, sem colisão e sem dano.
...
Ouvir o estalo de ignição e segurar a saída da nuvem. A fumaça também corta a visão do conjurador.

## Apresentação no universo de Crushle

Cinzas em espiral baixa, selo circular de oficina e rastro âmbar apenas nos pés. Sem preencher a tela com chamas.
