...
ID: `smg_lightning` | Relâmpago | SMGs | [Asset Unity](../../../Data/Arsenal/Cartridges/smg_lightning.asset) | [Índice](../README.md)

## Papel tático

**Avanço + Controle.** Descarga de mobilidade acelera a entrada e aplica uma breve lentidão na zona de impacto. Prioriza tomada de espaço, sem dano em cadeia.
...
|---|---|---|---|---|---|
| Velocidade | Próprio usuário | Usuário | 1.5 s | 0 m | 20% |
| Lentidão | Inimigos | Impacto | 0.6 s | 1.5 m | 25% |

- **Velocidade:** Bônus de 20% na velocidade horizontal; não afeta gravidade nem altura do salto.
- **Lentidão:** Lentidão de 25% em alvos visíveis da área; sem travar controles.
...
Antecipar a curta janela de velocidade pelo som elétrico e recuar da marca de impacto. Não há teleporte.

## Apresentação no universo de Crushle

Runa em zigue-zague dourado e faíscas nos punhos; borda roxa fina para separar do Fogo.
