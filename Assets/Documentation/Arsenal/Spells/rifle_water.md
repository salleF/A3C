...
ID: `rifle_water` | Água | Rifles | [Asset Unity](../../../Data/Arsenal/Cartridges/rifle_water.asset) | [Índice](../README.md)

## Papel tático

**Bloqueio + Observação.** Névoa cobre a travessia. O pulso inicial de gotículas registra inimigos expostos junto ao impacto para planejar a tomada de ângulo.
...
|---|---|---|---|---|---|
| Fumaça | Mundo | Impacto | 5 s | 3.5 m | Não se aplica |
| Revelação | Inimigos | Impacto | 1 s | 2.5 m | Não se aplica |

- **Fumaça:** Bloqueio visual simétrico.
- **Revelação:** Ping único de posição, sem seguir o movimento e sem atravessar paredes.
...
Recuar do pulso e reposicionar durante os 5 s de névoa. Não revela quem estiver em outra sala.

## Apresentação no universo de Crushle

Névoa ciano pálida com runa de gota e ping circular; evitar branco tão intenso quanto o portal.
