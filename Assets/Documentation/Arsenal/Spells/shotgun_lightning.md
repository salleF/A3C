...
ID: `shotgun_lightning` | Relâmpago | Escopetas | [Asset Unity](../../../Data/Arsenal/Cartridges/shotgun_lightning.asset) | [Índice](../README.md)

## Papel tático

**Controle + Bloqueio.** Descarga curta desacelera inimigos próximos do impacto para preparar um segundo disparo. Não atordoa câmera ou mouse.
...
|---|---|---|---|---|---|
| Lentidão | Inimigos | Impacto | 0.6 s | 2 m | 50% |

- **Lentidão:** Aplica uma vez por ativação a inimigos com linha de visão do impacto. Duração fixa, sem acúmulo por bago.
...
Manter distância da marca de descarga ou usar cobertura sólida. O efeito não atravessa paredes.

## Apresentação no universo de Crushle

Arcos curtos entre pequenas runas no chão, sem linhas até alvos ocultos.
