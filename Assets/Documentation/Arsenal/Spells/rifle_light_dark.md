# Observatório do Eclipse

ID: `rifle_light_dark` | Luz & Escuridão | Rifles | [Asset Unity](../../../Data/Arsenal/Cartridges/rifle_light_dark.asset) | [Índice](../README.md)

## Papel tático

**Bloqueio + Observação.** Escuridão bloqueia uma linha e Luz registra a posição de inimigos expostos junto ao ponto escolhido. Nunca ignora escudo nem aumenta dano do rifle.
...
- Alcance máximo do ponto de impacto elemental: **45 m**.
- Armas compatíveis: [FAMAS Arcano](../Weapons/arcane_famas.md), [Vandal Rúnico (AK)](../Weapons/runic_vandal.md), [Phantom Arcano (M4)](../Weapons/arcane_phantom.md), [Guardian Arcano](../Weapons/arcane_guardian.md).
...
|---|---|---|---|---|---|
| Fumaça | Mundo | Impacto | 5 s | 3 m | Não se aplica |
| Revelação | Inimigos | Impacto | 1.5 s | 4 m | Não se aplica |

- **Fumaça:** Metade Escuridão: fumaça simétrica.
- **Revelação:** Metade Luz: ping único respeitando oclusão; não é visão global.
...
Mudar de posição após a marca e usar cobertura antes do impacto. A nuvem corta também a visão do usuário.

## Apresentação no universo de Crushle

Esfera de névoa grafite com constelação branca periférica, sem símbolos ocultos que entreguem inimigos fora da área.
