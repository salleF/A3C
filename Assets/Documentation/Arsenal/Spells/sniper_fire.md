...
ID: `sniper_fire` | Fogo | Snipers | [Asset Unity](../../../Data/Arsenal/Cartridges/sniper_fire.asset) | [Índice](../README.md)

## Papel tático

**Observação + Suporte.** Sonda térmica registra inimigos perto do impacto e um pulso de forja acelera aliados próximos do atirador, ajudando o reposicionamento recuado.
...
| Velocidade | Aliados | Usuário | 2 s | 3 m | 10% |

- **Revelação:** Ping inicial, limitado por linha de visão do impacto.
- **Velocidade:** Aliados vivos próximos do atirador no disparo recebem 10% de velocidade; exige visão livre.
...
Recuar da sonda e mudar de posição após o ping. Nenhuma chama aplica dano periódico.

## Apresentação no universo de Crushle

Pequeno selo de farol na superfície atingida e runas âmbar nos pés dos aliados beneficiados.
